...
func Protected(v bool) predicate.Category {
...
func ProtectedEQ(v bool) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldProtected, v))
}
...
func HasSeries() predicate.Category {
...
func HasSeriesWith(preds ...predicate.Series) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := newSeriesStep()
