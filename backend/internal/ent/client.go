...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Chapter, c.EtagCache, c.ImportEntry, c.LatestSeries, c.Owner,
...
type (
	hooks struct {
		Chapter, EtagCache, ImportEntry, LatestSeries, Owner, ProviderChapter, Series,
		SeriesProvider, Settings, SourceEvent, SuwayomiSyncState []ent.Hook
	}
	inters struct {
		Chapter, EtagCache, ImportEntry, LatestSeries, Owner, ProviderChapter, Series,
		SeriesProvider, Settings, SourceEvent, SuwayomiSyncState []ent.Interceptor
	}
)
