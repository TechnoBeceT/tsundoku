...
var (
	...
	ChaptersColumns = []*schema.Column{
		...
		{Name: "state", Type: field.TypeEnum, Enums: []string{"wanted", "downloading", "downloaded", "upgrade_available", "upgrading", "failed", "permanently_failed", "superseded", "ignored"}, Default: "wanted"},
