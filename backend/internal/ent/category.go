...
func (e CategoryEdges) SeriesOrErr() ([]*Series, error) {
	if e.loadedTypes[0] {
		return e.Series, nil
	}
...
// QuerySeries queries the "series" edge of the Category entity.
func (_m *Category) QuerySeries() *SeriesQuery {
	return NewCategoryClient(_m.config).QuerySeries(_m)
}
