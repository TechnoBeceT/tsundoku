...
const (
	// Label holds the string label denoting the sourcepreference type in the database.
	...
	// Table holds the table name of the sourcepreference in the database.
	Table = "source_preferences"
)

// Columns holds all SQL columns for sourcepreference fields.
var Columns = []string{
	FieldID,
	FieldSourceID,
	FieldKey,
...
// OrderOption defines the ordering options for the SourcePreference queries.
