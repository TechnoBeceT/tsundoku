// Package sourceengine_test — shared test image fixtures.
//
...
//
// Ported verbatim (aside from the package name) from the retired
// internal/suwayomi/testimages_test.go — see GAP-083.
